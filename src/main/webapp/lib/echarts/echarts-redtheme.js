    ...
    dataZoom: {
        ...
        fillerColor: 'rgba(216,54,27,0.2)',   // 濉厖棰滆壊
        handleColor: '#d8361b'     // 鎵嬫焺棰滆壊
    },
    ...
    k: {
        itemStyle: {
            normal: {
                color: '#f16b4c',          // 闃崇嚎濉厖棰滆壊
                color0: '#f7b4a9',      // 闃寸嚎濉厖棰滆壊
                lineStyle: {
                    width: 1,
                    color: '#d8361b',   // 闃崇嚎杈规棰滆壊
                    color0: '#d26666'   // 闃寸嚎杈规棰滆壊
                }
            }
        }
    },
