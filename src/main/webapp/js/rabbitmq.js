...
dbApp.controller('dbCtrl', function ($scope, $http,$location) {
    $scope.monitorParam = {dbName: "mysql",url: "127.0.0.1", dbType:"MYSQL",dbUsername:"root",dbPassword:"root123",dbPort:"15672",dbSID:"",connectType:"SSH",hostPort:"22",hostUsername:"guest",hostPassword:"guest"};
