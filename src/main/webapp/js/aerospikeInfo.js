...
var dbInfoApp = angular.module('dbInfoApp', []);
    ...
    return {
        ...
        link: function () {
            loadtimespentOption = {
                ...
                legend: {
                    data:['Writes per second','Reads per second']
                },
                calculable: true,
                xAxis: [
                    {
...
dbInfoApp.directive('sqlwaitstatesChart', function () {
    return {
        ...
        link: function () {
            ...
            sqlWaitStatesChartAtResource = echarts.init(document.getElementById("sqlWaitStates"),'shine');
...
dbInfoApp.directive('avgconnectChart', function () {
    return {
        ...
        link: function () {
            ...
            avgconnectChartAtResource = echarts.init(document.getElementById("avgConnect"), 'blue');
